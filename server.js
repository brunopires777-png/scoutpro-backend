...
app.get('/api/value-bets', async (req, res) => {
  try {
    ...
    console.log(`[value-bets] ${jogos.length} jogos futuros encontrados`);
    if(!jogos.length){ return res.json({ results:[], total:0, source:'internal_calc' }); }
